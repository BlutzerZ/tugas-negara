                            ...
                            <table className="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                    {filteredStores.map((store) => (
                                        <tr key={store.id} className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            <td className="p-4">
                                            ...
                                            <td className="p-4">
                                                <div className="grid grid-cols-3 gap-2 text-sm">
                                                    <div>
                                                        <span className="font-medium">30ml:</span> {store.stock_30ml}
                                                    </div>
                                                    <div>
                                                        <span className="font-medium">Roll:</span> {store.stock_roll_on}
                                                    </div>
                                                    <div>
                                                        <span className="font-medium">20ml:</span> {store.stock_20ml}
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="p-4">
