      ...
      <div className="container mx-auto grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Nama Toko</p>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Parfum King</h2>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Stock Spray 30 ml</p>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">452</h2>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Stock Spray 20 ml</p>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">334</h2>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Stock Roll On</p>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">222</h2>
            </div>
          </div>
        </div>
      </div>
